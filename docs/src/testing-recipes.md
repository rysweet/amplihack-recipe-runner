...
| [all-methods](https://github.com/rysweet/amplihack-recipe-runner/blob/main/recipes/testing/all-methods.yaml) | All whitelisted string methods: `strip()`, `lower()`, `upper()`, `startswith()`, `endswith()`, `replace()`, `split()`, `join()`, `count()`, `find()` |
